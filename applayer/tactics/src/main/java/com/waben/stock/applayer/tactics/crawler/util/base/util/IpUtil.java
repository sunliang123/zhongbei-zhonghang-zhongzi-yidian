...
import com.waben.stock.applayer.tactics.crawler.util.http.HttpTools;
...
public class IpUtil {
    ...
    public static JSONObject getIp(String ip) {
        String result = HttpTools.doGet("http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=json&ip=" + ip,null);
    ...
    public static String getIpAddr() {
        ...
        String ip = HttpTools.doGet("http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=json",null);
        String info = "";
    ...
    public static String getIpCity() {
        String ip = HttpTools.doGet("http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=json&ip=",null);
        String info = "";
        JSONObject obj = (JSONObject) JSON.parse(ip);
        info += obj.getString("city");
    ...
    public static String getWeather(String location) {
        ...
        String ip = HttpTools.doGet(url,null);
     ...
     * @return
     */
    public static String getEth0InetIPLinux() {
    ...
    public static String getEth1InetIPLinux() {
        String cmd = " ip addr ls eth1 |grep -E -o '([0-9]{1,3}[\\.]){3}[0-9]{1,3}' ";
