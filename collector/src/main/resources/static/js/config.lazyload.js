...
angular.module('app')
	...
	.constant('JQ_CONFIG', {
			...
			dataTable:      ['vendor/jquery/datatables/jquery.dataTables.min.js',
													...
													'vendor/jquery/datatables/extensions/Select/js/dataTables.select.min.js',
													'vendor/jquery/datatables/dataTables.bootstrap.css',
													'vendor/jquery/datatables/extensions/Select/css/select.bootstrap.min.css'],
			...
			zTree:          ['vendor/jquery/zTree/js/jquery.ztree.core.js',
													'vendor/jquery/zTree/css/zTreeStyle/zTreeStyle.css']
		}
	)
	// oclazyload config
